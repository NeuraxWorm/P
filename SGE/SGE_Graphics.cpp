...
// Created by:	Peter Chan, Run Ming Zhong
//====================================================================================================
...
void SGE_Sprite::CRender(void)
{
	float x, y;
	mpSprite->GetPosition(x, y);
	const int tWidth = mpSprite->GetTexture()->GetWidth();
	const int tHeight = mpSprite->GetTexture()->GetHeight();
